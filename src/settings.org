...
***** Compile
      ...
      (global-set-key (kbd "<f5>") (lambda ()
      		(interactive)
		(setq-local compileation-read-command nil)
...
***** Debug(gdb)
      ...
      (setq 
      		...
      		gdb-many-windows t
		;; Non-nil means display source file containing the main routin at startup
	        Gdb-show-main t)
      #+END_SRC
*** SLIME
    #+BEGIN_SRC emacs-lisp
...
** Keybinding
    ...
    | M-S-p     | swap line to up                           |
    | M-S-n     | swap line to down                         |
